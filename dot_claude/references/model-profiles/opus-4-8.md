...
Source: https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/prompting-claude-opus-4-8 + https://platform.claude.com/docs/en/about-claude/models/migration-guide
Distilled: 2026-07-03
