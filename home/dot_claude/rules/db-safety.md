...
- Never build a destructive database command from parameter, brace, glob, or runtime expansion. The hook matches known literal patterns on a quote/backslash-normalized copy; it is an advisory guard, not a shell evaluator
