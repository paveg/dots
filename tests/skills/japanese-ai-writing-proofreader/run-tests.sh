#!/usr/bin/env bash
# Fixture regression check: verify dot_claude/skills/japanese-ai-writing-proofreader/scripts/lint.py
...
# dot_claude/skills/japanese-ai-writing-proofreader/scripts/fixtures/, update
...
LINT="${REPO_ROOT}/dot_claude/skills/japanese-ai-writing-proofreader/scripts/lint.py"
SMELLY_FIXTURE="${REPO_ROOT}/dot_claude/skills/japanese-ai-writing-proofreader/scripts/fixtures/ai-smelly.md"
NATURAL_FIXTURE="${REPO_ROOT}/dot_claude/skills/japanese-ai-writing-proofreader/scripts/fixtures/natural.md"
